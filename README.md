...
```
cd existing_repo
git remote add origin https://gitlab.praktikum-services.ru/std-013-60/infrastructure.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.praktikum-services.ru/std-013-60/infrastructure/-/settings/integrations)
